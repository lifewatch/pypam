...
[pyhydrophone](https://github.com/lifewatch/pyhydrophone).
Check the docs of pyhydrophone to know the specific parameters needed for your hydrophone.
...
-------------------------------------
To create/process an acoutic file, you can run::
