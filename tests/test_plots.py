...
class TestPlots(unittest.TestCase):
    def setUp(self) -> None:
        self.ds = xarray.open_dataset(f'{dir}/test_data/test_day.nc')
    ...
    def test_plot_spd(self):
        ds_spd = pypam.utils.compute_spd(self.ds, data_var='millidecade_bands', percentiles=[1, 10, 50, 90, 99])
    ...
    def test_plot_multiple_spectrum_median(self):
        ...
        pypam.plots.plot_multiple_spectrum_median(ds_dict=ds_dict, data_var='millidecade_bands', show=True,
    ...
    def test_summary_plot(self):
        ...
        pypam.plots.plot_summary_dataset(ds=self.ds, percentiles=pctlev, data_var='millidecade_bands',
                                         ...
                                         save_path=f'{dir}/test_data/data_exploration/img/data_overview/'
